...
class FileLoader:
    ...
    def __init__(self, opt):
        ...
        train_zsl_df = pd.read_pickle(opt.train_data_file)
        self.train_data = proteinData(train_zsl_df, self.train_terms, self.prot_vector, self.prot_description, gpu_ids=opt.gpu_ids)
