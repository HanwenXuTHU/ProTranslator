...
class ProTranslator:
    ...
    def __init__(self, model_config):
        ...
        self.model = ProTranslatorModel.deepSDNModel(input_nc=model_config.input_nc,
...
def main():
    ...
    logger = utils.get_logger(data_opt.dataset + data_opt.logger_name.format(feature_symb))
